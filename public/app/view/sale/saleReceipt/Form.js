Ext.define('App.view.sale.saleReceipt.Form', {
    extend: 'Ext.form.Panel',
    alias: 'widget.saleReceiptForm',
    bodyPadding: 20,
    border: true,
    autoScroll: true,
    buttons: [
...

        {
            ...
            items: [{
                ...
                items: [{
                    ...
                    allowBlank: false,
                    readOnly: true,
                    fieldLabel: 'Sale Receipt No.<span style="color:red">*</span>',
                }, {
                    xtype: 'datefield',
                ...
                editor: {
                    ...
                    listeners: {
                        select: function(combo, record, index) {
                            var rec = record[0];
                            App.app.getController("sale.SaleReceipt").itemRecord = rec;
...

                {
                    ...
                    editor: {
                        ...
                        listeners: {
                            select: function(combo, record, index) {
                                var rec = record[0];
                                App.app.getController("sale.SaleReceipt").umRecord = rec;
                    ...
                    items: [{
                        ...
                        handler: function(grid, rowIndex) {
                            var ctrl = App.app.getController("sale.SaleReceipt");
            ...
            items: [{
                ...
                items: [{
                    ...
                    fieldLabel: 'VAT(%)',
                    name: 'tax_percentag',
                    value: App.store.Config.defaultVAT,
                    minValue: 0
                }, {
                    xtype: 'displayfield',
