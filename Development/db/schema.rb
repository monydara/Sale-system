...
ActiveRecord::Schema.define(version: 20170916143841) do
  ...
  create_table "adjust_stock_types", force: true do |t|
  ...
  create_table "adjust_stocks", force: true do |t|
    t.date     "date"
  ...
  create_table "eoms", force: true do |t|
  ...
  create_table "issue_rental_details", force: true do |t|
    t.integer  "item_id"
    t.text     "description"
  ...
  create_table "issue_rentals", force: true do |t|
  ...
  create_table "item_group_details", force: true do |t|
    t.integer  "item_id"
    t.decimal  "qty",        precision: 10, scale: 0
    t.integer  "um_id"
    t.decimal  "multiplier", precision: 10, scale: 0
    t.decimal  "total_qty",  precision: 10, scale: 0
    t.boolean  "is_delete"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "lead_flag", force: true do |t|
    t.string   "name"
    t.text     "description"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "lead_opportunities", force: true do |t|
    t.string   "code"
  ...
  create_table "lead_opportunity_details", force: true do |t|
  ...
  create_table "opening_stock_details", force: true do |t|
  ...
  create_table "opening_stocks", force: true do |t|
    t.integer  "location_id"
    t.date     "date"
  ...
  create_table "receive_payment_details", force: true do |t|
  ...
  create_table "receive_payments", force: true do |t|
  ...
  create_table "rel_menu_roles", force: true do |t|
    t.integer  "menu_id"
    t.integer  "role_id"
  ...
  create_table "sale_quotation_details", force: true do |t|
    t.integer  "sale_quotation_id"
    t.integer  "item_id"
    t.integer  "item_group_id"
    t.text     "description"
  ...
  create_table "sale_quotations", force: true do |t|
  ...
  create_table "stock_balances", force: true do |t|
    t.integer  "item_id"
    t.date     "date"
    t.decimal  "balance",    precision: 18, scale: 6
    t.integer  "created_by"
  ...
  create_table "stock_transactions", force: true do |t|
    ...
    t.integer  "item_id"
    t.string   "serial_no",           limit: 45
    t.decimal  "open_qty",                       precision: 10, scale: 0
    t.decimal  "remain_qty",                     precision: 10, scale: 0
    t.float    "qty"
    t.integer  "um_id"
    t.float    "total_qty"
    t.decimal  "input_cost",                     precision: 18, scale: 6
    t.decimal  "last_value",                     precision: 10, scale: 0
  ...
  create_table "transfer_stock_details", force: true do |t|
  ...
  create_table "vender_balances", force: true do |t|
  ...
  create_table "vender_transactions", force: true do |t|
    t.integer  "transaction_id"
    t.date     "date"
